            ...
            <section class="text-gray-600 body-font ">
                <div class="container px-5 py-24 mx-auto bg-slate-100">
                    <div class="flex flex-col text-center w-full mb-20">
                        <h1 class="sm:text-6xl text-2xl font-medium title-font mb-4 text-black">Our Programs</h1>
                ...
                <div class="container px-5 py-24 mx-auto">
                    <div class="flex flex-wrap -mx-4 -mb-10 text-center">
                        <div class="sm:w-1/3 mb-10 px-4">
                            ...
                            <button class="flex mx-auto mt-6 text-white bg-indigo-500 border-0 py-2 px-5 focus:outline-none hover:bg-indigo-600 rounded">See more</button>
                        </div>
                        <div class="sm:w-1/3 mb-10 px-4">
                            <div class="rounded-lg h-64 overflow-hidden">
